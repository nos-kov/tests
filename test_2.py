...
duration_index_sorted = sorted(duration_index)
mcount_index_sorted =  sorted(mcount_index)
...
# Допишите код ниже:
for n,k in duration_index_sorted:
  indexes_d.append(k)

# Для indexes_m напишите аналогичный код самостоятельно:
for n,k in mcount_index_sorted:
  indexes_m.append(k)
...
def test_equal_lenght(list1, list2):
    
    assert len(list1)==len(list2), 'lenght is different'

if __name__ == "__main__":

    test_equal_lenght(indexes_d, indexes_m)
